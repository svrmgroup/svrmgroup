    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
        ...
        >
          ...
          <a
            href={buildWhatsAppUrlRaw("Hi SVRM Group, I saw your homepage and would like to learn more about your services. Please assist me with availability and booking details.")}
            target="_blank"
