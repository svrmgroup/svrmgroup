const Bespoke = () => (
  <section className="relative py-24 md:py-40 bg-surface-deep overflow-hidden">
    <div className="relative max-w-4xl mx-auto px-6 text-center">
      <div className="gold-divider w-16 mx-auto mb-10" />
      <p className="eyebrow">Bespoke</p>
      <h2 className="font-serif text-3xl md:text-6xl mt-6 text-foreground leading-[1.1]">
