  ...
  return (
    <main className="bg-background text-foreground min-h-screen">
      <Seo
        ...
        path="/security"
        keywords="security services Cape Town, VIP security Cape Town, executive security Cape Town, executive protection Cape Town, private security Cape Town, close protection Cape Town, luxury travel security South Africa, armed close protection Cape Town, bodyguard Cape Town, executive protection South Africa, armoured vehicle hire, bullet proof BMW 7 Series, armoured BMW X5, Mercedes G63 convoy, residential security Cape Town, event security, secure airport transfer, PSiRA security, VIP protection South Africa, close protection officer Cape Town, hire bodyguard Cape Town, VIP protection services South Africa, celebrity security Cape Town, film crew security Cape Town, business executive protection Johannesburg, armoured car hire South Africa, bulletproof car hire Cape Town, security driver Cape Town, secure transport Cape Town, residential guarding Cape Town, event security company Cape Town, private security company Cape Town prices, family protection Cape Town, travel risk management South Africa, PSiRA registered security Cape Town, discreet protection Atlantic Seaboard"
        image={bmw7}
