  ...
  return (
    <main className="bg-background text-foreground min-h-screen">
      <Seo
        ...
        path="/rentals"
        keywords="luxury car rental Cape Town, self-drive car hire Cape Town, rent BMW Cape Town, Mercedes E-Class rental, Range Rover Sport hire, Porsche Cayenne rental, Rolls-Royce self drive, G-Wagon rental Cape Town, exotic car hire South Africa, weekend car rental Cape Town, monthly car rental, airport car delivery Cape Town, CTIA car hire, chauffeur optional, cheap luxury rental Cape Town, honeymoon car hire, wedding car rental, film production car hire, business traveller car rental Cape Town, best car rental Cape Town, car rental Cape Town, car hire Cape Town, luxury car hire Cape Town airport, rent a car Cape Town no deposit, automatic car rental Cape Town, SUV rental Cape Town, 4x4 hire Cape Town, convertible hire Cape Town, sports car rental Cape Town, Mercedes rental Cape Town, BMW hire Cape Town, Audi rental Cape Town, Range Rover rental Cape Town, Porsche hire Cape Town, Lamborghini hire Cape Town, Rolls-Royce hire Cape Town, G-Wagon hire Cape Town, long term car rental Cape Town, monthly car hire Cape Town, weekly car hire Cape Town, car rental delivered to hotel Cape Town, car hire with driver option Cape Town, luxury car hire Stellenbosch, car hire Camps Bay, prestige car rental South Africa, car rental for tourists Cape Town, car hire requirements South Africa"
        image={rentalsOg}
        jsonLd={{
