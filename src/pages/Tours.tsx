...
const Tours = () => (
  <main className="bg-background text-foreground min-h-screen">
    <Seo title={"Private Cape Town Tours | Safari, Garden Route, Marine & Wellness — SVRM"} description={"Privately guided Cape Town tours designed around you — Big 5 safari, Garden Route road trips, whale & shark encounters, Table Mountain, Cape Point, townships, photography, helicopter scenics and wellness retreats. English, Arabic, French, Mandarin and more."} path="/tours" keywords="private tours Cape Town, luxury Cape Town day tour, best Cape Town tours, safari from Cape Town, Big 5 safari South Africa, Garden Route private tour, Cape Peninsula private tour, Cape Point tour, Table Mountain private tour, whale watching Hermanus, shark cage diving Gansbaai, penguins Boulders Beach, township cultural tour Cape Town, photography tour Cape Town, helicopter scenic Cape Town, family-friendly Cape Town tour, honeymoon tour South Africa, wellness retreat Western Cape, halal-friendly tour Cape Town, Arabic speaking guide Cape Town, Mandarin speaking guide, private guide Cape Town, bespoke Cape Town itinerary" image={toursOg} jsonLd={{ "@context": "https://schema.org", "@type": "Service", serviceType: "Private Tours", name: "SVRM Private Tours", provider: { "@type": "Organization", name: "SVRM Group", url: "https://svrm.group/" }, areaServed: [{ "@type": "City", name: "Cape Town" }, { "@type": "Country", name: "South Africa" }] }} />
    <Nav />
    <PageHero
