...
import toursOg from "@/assets/svc-exp-safari.jpg";

const Tours = () => (
  <main className="bg-background text-foreground min-h-screen">
    <Seo title={"Private Cape Town Tours | Safari & Garden Route — SVRM"} description={"Privately guided Cape Town tours — Big 5 safari, Garden Route, Cape Point, whale & shark encounters, helicopter scenics and wellness retreats."} path="/tours" keywords="private tours Cape Town, luxury Cape Town day tour, best Cape Town tours, safari from Cape Town, Big 5 safari South Africa, Garden Route private tour, Cape Peninsula private tour, Cape Point tour, Table Mountain private tour, whale watching Hermanus, shark cage diving Gansbaai, penguins Boulders Beach, township cultural tour Cape Town, photography tour Cape Town, helicopter scenic Cape Town, family-friendly Cape Town tour, honeymoon tour South Africa, wellness retreat Western Cape, halal-friendly tour Cape Town, Arabic speaking guide Cape Town, Mandarin speaking guide, private guide Cape Town, bespoke Cape Town itinerary, Cape Town tours, day tours from Cape Town, private tour guide Cape Town, luxury safari South Africa, Big 5 safari day trip Cape Town, Aquila safari from Cape Town, Cape Winelands tour, Stellenbosch wine tasting tour, Franschhoek wine tram tour, Bo-Kaap cooking class Cape Town, Robben Island and city tour, Table Mountain and Kirstenbosch tour, Boulders Beach penguin tour, Cape Point day tour price, Hermanus whale watching tour, Gansbaai shark cage diving tour, Garden Route 5 day tour, private Cape Town city tour, half day Cape Town tour, luxury day tour with chauffeur Cape Town, couples private tour Cape Town, family day tour Cape Town, private tour for cruise passengers Cape Town" image={toursOg} jsonLd={[{ "@context": "https://schema.org", "@type": "Service", serviceType: "Private Tours", name: "SVRM Private Tours", provider: { "@type": "Organization", name: "SVRM Group", url: "https://svrm.group/" }, areaServed: [{ "@type": "City", name: "Cape Town" }, { "@type": "Country", name: "South Africa" }] }, { "@context": "https://schema.org", "@type": "ItemList", name: "SVRM private tours", itemListElement: tours.map((t, i) => ({ "@type": "ListItem", position: i + 1, name: t.label, url: `https://svrm.group/tours/${t.slug}` })) }, { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://svrm.group/" }, { "@type": "ListItem", position: 2, name: "Tours", item: "https://svrm.group/tours" }] }]} />
    <Nav />
    <PageHero
