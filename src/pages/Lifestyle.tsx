...
const Lifestyle = () => (
  <main className="bg-background text-foreground min-h-screen">
    <Seo title={"Lifestyle Management & Yachting Cape Town | SVRM"} description={"Private yachting, day charters and luxury lifestyle management along the Cape Town coast — curated with the discretion that defines SVRM Group."} path="/lifestyle" keywords="luxury lifestyle management Cape Town, yacht charter Cape Town, private yacht hire V&A Waterfront, sunset cruise Cape Town, day charter Atlantic Seaboard, motor yacht hire, sailing yacht Cape Town, luxury experiences South Africa" image={yachtImg} jsonLd={{ "@context": "https://schema.org", "@type": "Service", serviceType: "Lifestyle Management & Yachting", provider: { "@type": "Organization", name: "SVRM Group", url: "https://svrm.group/" }, areaServed: { "@type": "City", name: "Cape Town" } }} />
    <Nav />
    <PageHero
