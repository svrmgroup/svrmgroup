  ...
  return (
    <>
      <Seo
        ...
        description="Private chauffeured airport transfers across Cape Town, including the V&A Waterfront — CPT to Camps Bay, V&A, Sea Point, Stellenbosch and the Winelands. Flat rates, flight monitoring, meet & greet, child seats and extra luggage. Book on WhatsApp in minutes."
        ...
        jsonLd={{
          ...
          description:
            "Private chauffeured airport transfers across Cape Town, including the V&A Waterfront with meet & greet, flight monitoring and a luxury fleet including Mercedes V-Class, E-Class and BMW X3.",
          provider: {
            "@type": "Organization",
            name: "SVRM Group",
