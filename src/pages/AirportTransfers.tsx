  ...
  return (
    <>
      <Seo
        ...
        description="Private chauffeured airport transfers across Cape Town — V&A Waterfront, Camps Bay, Clifton, Bantry Bay, Sea Point, Atlantic Seaboard, City Bowl, Stellenbosch and Franschhoek. CPT to all Cape Town luxury areas. Flat rates, flight monitoring, meet & greet, child seats and extra luggage. Book on WhatsApp in minutes."
        ...
        jsonLd={{
          ...
          description:
            "Private chauffeured airport transfers across Cape Town — V&A Waterfront, Camps Bay, Clifton, Bantry Bay, Sea Point, Atlantic Seaboard, City Bowl, Stellenbosch and Franschhoek — with meet & greet, flight monitoring and a luxury fleet including Mercedes V-Class, E-Class and BMW X3.",
          provider: {
            "@type": "Organization",
            name: "SVRM Group",
