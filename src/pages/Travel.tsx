  ...
  return (
    <main className="bg-background text-foreground min-h-screen">
      <Seo
        ...
        description={"Private chauffeur hire across Cape Town, including the V&A Waterfront: Maybach, S-Class, Range Rover and GLS with an NDA-bound chauffeur — plus private jets, helicopters, yachts and a 7-day chauffeured itinerary at 10% off."}
        path="/chauffeur"
      ...
      <PageHero
        ...
        subtitle="A private, NDA-bound chauffeur and the vehicle of your choice across Cape Town, including the V&A Waterfront — by the hour, the day, or across our signature 7-day Cape Town itinerary at 10% off the vehicle total. Jets, helicopters and yachts under the same concierge."
