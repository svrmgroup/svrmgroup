  ...
  return (
    <main className="bg-background text-foreground min-h-screen">
      <Seo
        ...
        description={"Private chauffeur hire in Cape Town: Maybach, S-Class, Range Rover and GLS with an NDA-bound chauffeur — plus private jets, helicopters, yachts and a 7-day chauffeured itinerary at 10% off."}
        path="/chauffeur"
        keywords="chauffeur service Cape Town, private chauffeur Cape Town, chauffeur hire Cape Town, luxury chauffeur Cape Town, luxury chauffeur South Africa, chauffeur driven car Cape Town, hire a driver Cape Town, personal driver Cape Town, English speaking driver Cape Town, VIP chauffeur Cape Town, executive chauffeur Cape Town, corporate chauffeur Cape Town, Maybach chauffeur Cape Town, Mercedes-Maybach chauffeur Cape Town, Maybach S-Class Cape Town, Mercedes S-Class chauffeur Cape Town, S Class chauffeur Cape Town, Mercedes GLS hire Cape Town, Mercedes-Benz GLS chauffeur Cape Town, GLS with driver Cape Town, luxury 7 seater SUV chauffeur, premium SUV transfer Cape Town, Mercedes V-Class chauffeur Cape Town, BMW 7 Series with driver, Rolls-Royce chauffeur Cape Town, Rolls-Royce Phantom chauffeur, Range Rover chauffeur Cape Town, wedding chauffeur Cape Town, matric dance chauffeur Cape Town, hourly chauffeur hire Cape Town, full day chauffeur Cape Town, multi day chauffeur Cape Town, weekly chauffeur hire Cape Town, 7 day Cape Town itinerary, 7 day chauffeured tour Cape Town, one week Cape Town itinerary with driver, private driver and guide Cape Town, Cape Town Winelands chauffeur, Stellenbosch wine tour with driver, Franschhoek wine tour chauffeur, Cape Peninsula chauffeur tour, Table Mountain private tour driver, Aquila safari transfer Cape Town, luxury airport transfer Cape Town, Cape Town airport chauffeur, close protection driver Cape Town, discreet chauffeur Cape Town, chauffeur for celebrities Cape Town, chauffeur rates Cape Town, private jet charter Cape Town, empty leg jet Cape Town, helicopter transfer Cape Town, scenic helicopter flight Cape Town, superyacht charter Cape Town, yacht hire V&A Waterfront, luxury car fleet Cape Town, executive transfers South Africa, corporate roadshow transport, group transfers Sprinter, luxury Winelands day trip"
        image={travelOg}
        jsonLd={[{
          ...
          areaServed: [{ "@type": "City", name: "Cape Town" }, { "@type": "AdministrativeArea", name: "Western Cape" }, { "@type": "Country", name: "South Africa" }],
          hasOfferCatalog: {
            "@type": "OfferCatalog",
      ...
      <PageHero
        ...
        subtitle="A private, NDA-bound chauffeur and the vehicle of your choice — by the hour, the day, or across our signature 7-day Cape Town itinerary at 10% off the vehicle total. Jets, helicopters and yachts under the same concierge."
