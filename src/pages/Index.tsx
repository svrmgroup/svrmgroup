...
const Index = () => (
  <main className="bg-background text-foreground">
    <Seo
      ...
      description="SVRM Group is a luxury concierge company in Cape Town, offering VIP chauffeur services, luxury vehicles, private tours, villas, security and bespoke experiences, curated around you."
      path="/"
