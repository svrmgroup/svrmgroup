...
function offersSeed() {
  const rows = [
    {
      slug: "maybach-flagship-chauffeur",
      title: "Mercedes-Maybach S-Class",
      eyebrow: "Flagship · Chauffeur",
      summary: "SVRM's flagship chauffeur experience — VIP transfers, events and full days.",
      price_zar: 22000,
      price_suffix: "/ day",
    ...
    },
    {
      ...
      eyebrow: "Honeymoon",
      summary: "Chauffeur, private villa, romantic experiences and the Cape — arranged end to end.",
      price_zar: null,
      cta_label: "Plan Your Honeymoon",
      cta_href: "/honeymoon-cape-town",
    },
    {
      slug: "luxury-anniversary-experience",
      title: "Luxury Anniversary Experience",
      eyebrow: "Anniversary",
      summary: "A bespoke celebration: Maybach chauffeur, private stay, yacht or Peninsula day.",
      price_zar: null,
      cta_label: "Plan Your Anniversary",
      cta_href: "/anniversary-cape-town",
    },
    {
      slug: "cape-peninsula-one-day-private-tour",
      title: "Cape Peninsula — One Day Private Tour",
      eyebrow: "Private Tour",
      summary: "Chapman's Peak, Cape Point, Boulders Beach and Simon's Town, chauffeur-driven.",
      price_zar: 8500,
      price_prefix: "From ",
      cta_label: "Book Private Tour",
      cta_href: "/tours/cape-peninsula",
    },
    {
      slug: "vip-security-close-protection",
      title: "VIP Security & Close Protection",
      eyebrow: "Security & Protection",
      summary: "Executive protection, travel security and discreet coordination in Cape Town.",
      price_zar: null,
